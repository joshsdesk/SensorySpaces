...
export default function SettingsScreen() {
    ...
    const renderToggle = (label, value, onValueChange) => (
        <View style={styles.row}>
            ...
            <Switch
                ...
                thumbColor={value ? "#5E35B1" : "#f4f3f4"}
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.header}>Community Admin</Text>
            <View style={styles.section}>
                <TouchableOpacity
                    style={styles.buttonRow}
                    onPress={() => navigation.navigate('Verification')}
                >
                    <Text style={styles.buttonLabel}>Verification Queue</Text>
                    <Text style={styles.chevron}>{">"}</Text>
                </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
    ...
    buttonLabel: { fontSize: 16, color: '#5E35B1' },
